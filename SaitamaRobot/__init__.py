...
oko = TelegramClient("TanjiroKamado", API_ID, API_HASH)
telethn = TelegramClient("tanjiro", API_ID, API_HASH)
pgram = Client("TanjiroPyro", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
