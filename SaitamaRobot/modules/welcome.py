        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "My master The Great Yorichi Arrived.",
                    reply_to_message_id=reply)
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! Someone with a Lover demon level just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "Oof! A normal slayer just joined!",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "Oof! A normal demon just joined!",
                    reply_to_message_id=reply)
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "The Great Harshira Just Leaved This Group.", reply_to_message_id=reply)
                return

            # Give the devs a special goodbye
            elif left_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "See you later at the Harshira's Headquarters!",
                    reply_to_message_id=reply,
                )
                return
